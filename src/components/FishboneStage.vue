<template>
  <div class="stage-wrap">
    <div ref="stageShell" class="stage-scroll">
      <div v-show="!renderErrorMessage" ref="stageHost" class="graph-stage"></div>
      <div v-if="renderErrorMessage" class="demo-error">
        <div>
...
import engine from "@/utils/fishboneLayout";
...
export default {
  ...
  methods: {
    ...
    resetView() {
      if (this.graph && typeof this.graph.fitView === "function") {
        this.graph.fitView();
      }
    },
    ensureExtensions() {
      ...
      class FishHeadNode extends G6.Rect {
        ...
        getHeadShapeStyle(attributes) {
          ...
          const path = [
            ["M", mirror * baseX, topY],
            ["C", mirror * browX, -halfH * 1.03, mirror * cheekX, -halfH * 0.96, mirror * jawX, upperJawY],
            ...
            ["C", mirror * cheekX, halfH * 0.96, mirror * browX, halfH * 1.03, mirror * baseX, bottomY],
            ["Z"],
          ];
